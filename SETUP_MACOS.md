...
- [Terminal Environment](#terminal-environment)
  ...
  - [7. Install OpenCode](#7-install-opencode)
  - [8. Clone and Link Dotfiles](#8-clone-and-link-dotfiles)
  - [9. Set Up Dotfiles Auto-Sync](#9-set-up-dotfiles-auto-sync)
  - [10. Install asdf plugins and versions](#10-install-asdf-plugins-and-versions)
